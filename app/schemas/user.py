...
This module defines Pydantic schemas for working with user data. It includes schemas for
creating and retrieving user information.

Usage:
1. Import this module to access the `UserBase`, `UserCreate`, and `User` Pydantic schemas
for user data validation and serialization.
2. These schemas are used to validate and serialize data for user creation, retrieval, and
